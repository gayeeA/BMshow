...
def movie_showtimes(request, movie_id):
    ...
    show_timings = movie.show_timings.all()
    return render(request, 'movie_showtimes.html', {'movie': movie, 'show_timings': show_timings})
        ...
        for seat_id in selected_Seats:
            ...
            try:
                ...
                send_mail(
                    ...
                    f'Your booking for {theaters.movie.name} at {theaters.name} for seat {seat.seat_number} has been confirmed.',
